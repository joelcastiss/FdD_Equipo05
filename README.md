...
|------|--------|-----|-----------|
| <img src="/Recursos/Imágenes/Gabriel_Paredes_Diaz.png" alt="Foto formal de Gabriel Paredes Diaz" width="90" /> | **Gabriel Helaman Paredes Diaz** | Responsable de investigación | Seguridad ocupacional, Analisis de datos, servicio comunitario |
